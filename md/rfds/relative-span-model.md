...
- **File identity:** carried directly on items as `source_file: SourceFile`. (When [macro expansion as a tracked query](./macro-expansion-tracked-query.md) lands, this becomes `input_bytes: InputBytes<'db>`.)
